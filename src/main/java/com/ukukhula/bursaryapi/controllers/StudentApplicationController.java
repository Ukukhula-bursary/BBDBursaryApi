...
public class StudentApplicationController {
  ...
  public ResponseEntity<?> getStudentApplications(@PathVariable int studentId) {
    ...
    StudentApplication application = studentApplicationService.findByStudentID(
      studentId
    );
  ...
  public ResponseEntity<?> updateStudentsApplicationStatus(
    ...
    int rowsAffected = studentApplicationService.updateStudentsApplicationStatus(
      updateBody.getApplicationID(),
      updateBody.getStatusID(),
      updateBody.getReviewerComment()
    );
  ...
  @ExceptionHandler(
    {
      StudentApplicationException.class,
  ...
  public ResponseEntity<?> updateStudentsApplicationColumnValue(
    ...
    try {
      ...
      Integer rowsAffected = studentApplicationService.updateStudentsApplicationColumnValue(
        studentID,
        columNameString,
        valueString
      );
  ...
  public ResponseEntity<?> addStudentApplication_NewStudent(
    ...
    if (Objects.isNull(studentApplication)) {
      return new ResponseEntity<>(
        "Unable to add student application",
