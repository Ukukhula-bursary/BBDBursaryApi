...
public class StudentApplicationService {
  ...
  public Integer updateStudentsApplicationStatus(
    ...
    return studentApplicationRepository.updateStudentsApplicationStatus(
      studentID,
      statusID,
      reviewerComment
    );
  ...
  public Integer updateStudentsApplicationColumnValue(
    ...
    return studentApplicationRepository.updateStudentsApplicationColumnValue(
      studentID,
      columnName,
      value
    );
  ...
  public StudentApplication studentApplication_NewStudent(
    StudentApplicationDetails_NewStudent studentApplicationDetails_NewStudent
  ) {
    int newStudentApplicationId = studentApplicationRepository.studentApplication_NewStudent(
    ...
    return studentApplicationRepository.getStudentApplicationById(
      newStudentApplicationId
    );
  }

  public StudentApplication studentApplication_ActiveStudent(
    StudentApplicationDetails_ActiveStudent studentApplicationDetails_ActiveStudent
  ) {
    int newStudentApplicationId = studentApplicationRepository.studentApplication_ActiveStudent(
